...
sub handleEmbedQT {
    ...
    my $QTFileWidth =
      &TWiki::Func::extractNameValuePair( $theAttributes, "width" );
    my $QTFileHeight =
      &TWiki::Func::extractNameValuePair( $theAttributes, "height" );

    return
"<OBJECT CLASSID=\"clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B\" WIDTH=\"$QTFileWidth\" HEIGHT=\"$QTFileHeight\" CODEBASE=\"http://www.apple.com/qtactivex/qtplugin.cab\"> <EMBED SRC=\"$QTFileName\" AUTOPLAY=\"true\" CONTROLLER=\"false\" PLUGINSPAGE=\"http://www.apple.com/quicktime/download/\"> </EMBED> </OBJECT>";
